...
const usuariosService = {
  ...
  async getAllUsuariosByAreaId(areaId) {
    try {
      const response = await axiosInstance.get(`${URL}/area/${areaId}`, {
  ...
  async getUsuarioById(id) {
    try {
      ...
      console.error(`Error al obtener el Usuario id: ${id} `, error);
      throw error;
    }
  },
  ...
  async getUsuarioByCuil(cuil) {
    try {
      ...
      console.error(`Error al obtener el Usuario con cuil: ${cuil} `, error);
      throw error;
    }
  },
